...
public class EarthBead extends AppCompatButton {
    ...
    public EarthBead(Context context) {
        super(context);
        init(context,null,0);
    ...
    public EarthBead(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context,attrs,0);
    }

    public EarthBead(Context context, AttributeSet attrs, int defStyleAttr) {
